...
Mega là ngoại lệ của luồng JSON: cấu hình License Key của gói và các trường Global Mega Block trong `Assets/XR/Settings/EasyAR Settings.asset`, xác thực bằng `sampleId=mega`, rồi dùng `scenePath` do báo cáo kiểm tra cảnh đề xuất khi Build Settings có các ứng viên Onsite/Simulator không rõ ràng.
