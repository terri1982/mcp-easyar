...
- Release: https://github.com/terri1982/mcp-easyar/releases/tag/v0.1.0-local-key.39
- Release tarball: https://github.com/terri1982/mcp-easyar/releases/download/v0.1.0-local-key.39/mcp-easyar-0.1.0.tgz
...
- Ready in `v0.1.0-local-key.39`: Mega local-key workflow with Android APK install/startup, fresh-project evidence, and physical-environment localization evidence.
