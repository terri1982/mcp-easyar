  ...
  if (sample.id === "mega") {
    ...
    await writeGeneratedFile(
      ...
      [
        ...
        "",
        "Current official docs snapshot (2026-07-01): EasyAR Sense Unity Plugin / for Mega 4003.0.0, EasyAR Mega support package and Mega Studio 2.13.0, XR device extension package 4000.0.1. For 4003+ Mega projects, prefer the MegaBlockController workflow over legacy Mega Studio generated node groups or BlockRoot-centered setup.",
        "",
        "PICO 4 Ultra Enterprise verified baseline: Unity 2022.3.62f3, EasyAR Sense Unity Plugin 4002.0.0, EasyAR Mega 2.12.6, EasyAR Unity XR device extension package 4000.0.0, PICO Unity Integration SDK 3.4.0, package name `com.easyar.mega.xrtest`, and a matching `4.x XR正式版` license. Re-run device validation before claiming the 4003.0.0 package line as verified.",
        "",
